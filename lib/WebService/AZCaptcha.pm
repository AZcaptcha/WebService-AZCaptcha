...
sub new {
    ...
    $args{url} ||= 'http://AZcaptcha.com/res.php';
    $args{sleep} ||= 3;
...
sub load {
    ...
    $self->request(url => 'http://AZcaptcha.com/load.php');
}
...
=head1 SYNOPSIS
    ...
    my $w2c = WebService::AZcaptcha->new(
...
WebService::AZcaptcha is for L<https://AZcaptcha.com/setting>
